...
class TransformersForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self._has_input_ids = "input_ids" in self._forward_params
        self._has_text_input_ids = "text_input_ids" in self._forward_params
    ...
    def forward(
        ...
        if self._has_input_ids:
            model_kwargs["input_ids"] = input_ids[None, ...]
        if self._has_text_input_ids:
            model_kwargs["text_input_ids"] = input_ids[None, ...]
        if self._has_input_ids or self._has_text_input_ids:
